...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(aplicacion.android.app.betusto.fruterinapoles.R.layout.activity_registro);
//Sincronizar variables
    ...
    private void logearUsuarioParaBD(final String uid) {
        GettersDeUsuarios g = new GettersDeUsuarios(usuarioStr, correoStr, contraseñaStr, "true", "false"); //Usuario se logea al crear la cuenta HAY QUE CREAR UN FALSE AL CERRAR SESION
