...
public class Activity_Merma extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__merma);

        spinner = findViewById(R.id.activity__merma_spinner);
        spinner2 = findViewById(R.id.activity__merma_spinner2);
        retirar = findViewById(R.id.activity__merma_tirarbutton);
        cantidadEntrada = findViewById(R.id.activity__merma_cantidadentradatext);
        cantidad = findViewById(R.id.activity__merma_edittext);

        final ArrayAdapter<String> adapter = new ArrayAdapter<String>(Activity_Merma.this,
        ...
        retirar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Fecha == null){
                    MU.MostrarToast(Activity_Merma.this, "Escoja un producto que tenga fechas de entradas");
                    detectorErrores=1;
                ...
                if(detectorErrores==0){
                    ...
                    BD.AlAñadirMerma(Producto, CantidadEscrita, Fecha);
                    BD.CrearArchivoCSV();
                    MU.MostrarToast(Activity_Merma.this, "La cantidad que marcó fue tirada exitosamente");
                    cantidad.setText("");
                    if(resta <= 0){
                        ...
                        Database.child("Entradas").child(snapshot.getKey()).child("NombreProducto").addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                if(CantidadTotalDeSnaps == CantidadDeSnapshots.size()) { //Ultimo ciclo del for ejecutar lo siguiente
                                    ...
                                    fechas.clear();
                                    adaptador = new ArrayAdapter<String>(Activity_Merma.this,
